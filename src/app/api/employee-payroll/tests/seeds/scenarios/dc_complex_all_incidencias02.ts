...
export default async function seedDC_Complex_AllIncidencias02(numberEmployee: string) {
  const { employee, location, ascription, employeeAttendanceType } = await createEmployeeSeed({
    numberEmployee: numberEmployee,
    name: "seedDC_Complex_AllIncidencias02",
  ...
  const { scheduleMap } = await generateMonthlyAttendances({
    ...
    month: 12,
    untilDay: 15,
    excludeDays: ["2025-12-05", "2025-12-06", "2025-12-07", "2025-12-08", "2025-12-09", "2025-12-10", "2025-12-14"],
    jornadas: {
      lunesMartes: {
        weekdays: [1, 2],
        startDay: 1,
