...
export default async function seedIntercalated_LMV_InasistenciaTotal(numberEmployee: string) {
  const { employee, location, ascription, employeeAttendanceType } = await createEmployeeSeed({
    numberEmployee: numberEmployee,
    name: "Intercalated_LMV_Inasistencia_Total",
  ...
  await generateIntercalatedAttendances({
    ...
    excludeDays: ["2025-12-01", "2025-12-03", "2025-12-05", "2025-12-08", "2025-12-10", "2025-12-12", "2025-12-15"],
    jornada: {
      startHourId: 17,
      endHourId: 33,
      checkIn: "08:00",
