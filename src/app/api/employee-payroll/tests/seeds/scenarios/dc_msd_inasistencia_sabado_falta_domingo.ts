...
export default async function seedDC_MSD_InasistenciaSabadoFaltaDomingo(numberEmployee: string) {
  const { employee, location, ascription, employeeAttendanceType } = await createEmployeeSeed({
    numberEmployee: numberEmployee,
    name: "DC_MSD_InasistenciaSabadoFaltaDomingo",
