  ...
  async getEmployeesPayrollByParams(filters: IEmployeePayrollFilters) {
    ...
    const query = `
        SELECT
            ...
            IFNULL(registro_incidencias.justificacion_reloj, 0) AS justificacion_reloj,
        ...
        FROM Employee e
            ...
            SELECT
                ...
                CAST(COUNT(DISTINCT CASE WHEN i.name = 'justificacion_reloj' THEN eid.id END) AS SIGNED) AS justificacion_entrada_salida,
