...
const UnpaidLeaveIncident: React.FC<IncidentItemProps> = ({ data, styles }) => {
  return (
    <>
      ...
      <View style={styles.row}>
        ...
        <Text style={[styles.cell, styles.uppercase, styles.italic, styles.lastCell, styles.lastRow, { flex: 1 }]}>
...
export default UnpaidLeaveIncident;
