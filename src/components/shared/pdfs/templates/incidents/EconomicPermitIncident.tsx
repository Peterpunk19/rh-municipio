...
const EconomicPermitIncident: React.FC<IncidentItemProps> = ({ data, styles }) => {
  return (
    <>
      ...
      <View style={styles.row}>
        ...
        <Text style={[styles.cell, styles.italic, styles.lastCell, styles.lastRow, { flex: 1 }]}>Normal</Text>
      </View>
    </>
  );
};

export default EconomicPermitIncident;
