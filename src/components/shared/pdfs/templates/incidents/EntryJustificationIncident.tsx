...
const EntryJustificationIncident: React.FC<IncidentItemProps> = ({ data, styles }) => {
  return (
    <>
      <View style={styles.row}>
        <Text style={[styles.cell, styles.cellHeader, { flex: 1, textAlign: "left" }]}>TIPO DE INCIDENCIA</Text>
        <Text style={[styles.cell, styles.cellHeader, { flex: 2, textAlign: "left" }]}>FECHA A JUSTIFICAR</Text>
...
export default EntryJustificationIncident;
