  ...
  return (
    <>
      ...
      <View style={combineStyles(styles?.flexColumn, styles?.alignItemsStart, { fontSize: 10, marginVertical: 15 })}>
        <Text>
          Por medio de la presente, solicito su autorización para realizar un cambio de horario de la lista de
          asistencia al personal con funciones administrativas. Debido a la naturaleza de sus responsabilidades, dicho
          personal no podrá cumplir con el registro de asistencia en el reloj digital.
        </Text>
      </View>
      <View style={combineStyles(styles?.table)}>
