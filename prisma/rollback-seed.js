    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, prisma.employeeType.deleteMany()];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, prisma.gender.deleteMany()];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, prisma.hour.deleteMany()];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, prisma.incident.deleteMany()];
                case 7:
                    _a.sent();
                    return [4 /*yield*/, prisma.incidentStatus.deleteMany()];
                case 8:
                    _a.sent();
                    return [4 /*yield*/, prisma.location.deleteMany()];
                case 9:
                    _a.sent();
                    return [4 /*yield*/, prisma.payroll.deleteMany()];
                case 10:
                    _a.sent();
                    return [4 /*yield*/, prisma.request.deleteMany()];
                case 11:
                    _a.sent();
                    return [4 /*yield*/, prisma.requestStatus.deleteMany()];
                case 12:
                    _a.sent();
                    return [4 /*yield*/, prisma.role.deleteMany()];
                case 13:
                    _a.sent();
                    return [4 /*yield*/, prisma.statusEmployee.deleteMany()];
                case 14:
                    _a.sent();
